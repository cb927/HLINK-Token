 ...
 */
contract HLINKToken is Ownable, IBEP20 {
    ...
    address developer_team = 0x523f8F98ecD1FD8a61196bA715D1f044381c29fC;
    ...
    function transferFrom(
        ...
        require(
            ...
            "HLINK Token: transfer amount exceeds allowance"
        );
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "HLINK Token: decreased allowance below zero"
        );
    ...
    function _transfer(
        ...
        require(
            sender != address(0),
            "HLINK Token: transfer from the zero address"
        );
        require(
            recipient != address(0),
            "HLINK Token: transfer to the zero address"
        );
        ...
        require(
            ...
            "HLINK Token: transfer amount exceeds balance"
        );
    ...
    function _mint(address account, uint256 amount) internal virtual {
        require(account != address(0), "HLINK Token: mint to the zero address");
    ...
    function _burn(address account, uint256 amount) internal virtual {
        require(
            account != address(0),
            "HLINK Token: burn from the zero address"
        );
        ...
        require(
            ...
            "HLINK Token: burn amount exceeds balance"
        );
    ...
    function _approve(
        ...
        require(
            owner != address(0),
            "HLINK Token: approve from the zero address"
        );
        require(
            spender != address(0),
            "HLINK Token: approve to the zero address"
        );
